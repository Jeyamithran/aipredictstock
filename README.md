...
<div align="center">
  <p><strong>AI Market Scanner</strong><br>
  <em>Multi-agent system selecting high-probability setups from thousands of tickers.</em></p>
  <img src="assets/screenshots/ai_scanner.png" width="800" alt="AI Scanner Dashboard" />
</div>

<br>

<div align="center">
  <p><strong>Institutional 0DTE Desk</strong><br>
  <em>Real-time Gamma Exposure (GEX) and Net Delta tracking for SPY 0DTE options.</em></p>
  <img src="assets/screenshots/odte_dashboard.png" width="800" alt="0DTE Dashboard" />
</div>

<br>

<div align="center">
  <p><strong>Deep Technical Analysis</strong><br>
  <em>AI-generated trade plans with automated support/resistance and volume profile analysis.</em></p>
  <img src="assets/screenshots/stock_analysis.png" width="800" alt="Stock Analysis" />
</div>

<br>

<div align="center">
  <p><strong>AI News Terminal</strong><br>
  <em>Automated "Bloomberg-style" market summaries generated by LLMs in real-time.</em></p>
  <img src="assets/screenshots/news_terminal.png" width="800" alt="News Terminal" />
</div>
